    ...
    <nav className="bg-brand-primary fixed w-full z-20 top-0 start-0 border-b border-brand-secondary shadow-lg">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
        ...
        <div
          ...
          id="navbar-main"
        >
          <ul className="flex flex-col font-medium mt-4 rounded-lg bg-brand-secondary/95 backdrop-blur-sm md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent md:backdrop-blur-none p-4 md:p-0 md:items-center">
            <li>
