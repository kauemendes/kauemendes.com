            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm text-brand-accent1 font-medium mb-1">{t('previousArticle')}</div>
            ...
            >
              <div className="flex items-start space-x-4">
                <div className="flex-1 min-w-0 text-right">
                  <div className="text-sm text-brand-accent1 font-medium mb-1">{t('nextArticle')}</div>
                  <h3 className="text-brand-neutral-light font-semibold group-hover:text-brand-accent1 transition-colors duration-300 line-clamp-2">
                    {nextPost.title}
                  </h3>
                </div>
