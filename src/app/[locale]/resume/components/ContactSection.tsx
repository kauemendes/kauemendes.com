    ...
    <div className="p-8 md:p-12">
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <div className="bg-paper-2 shadow-hard-sm border-2 border-ink p-6">
            ...
            <div className="space-y-4">
              ...
              <motion.button
                ...
                className="w-full flex items-center space-x-4 p-4 bg-accent/10 border border-accent/25 hover:bg-accent/20 transition-all duration-300"
              >
        ...
        <motion.div variants={itemVariants}>
          <div className="bg-paper-2 shadow-hard-sm border-2 border-ink p-6">
            ...
            <div className="grid grid-cols-1 gap-3">
              {social.map((profile, index) => (
                <motion.a
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center space-x-4 p-4 bg-paper border-2 border-ink hover:border-accent/40 transition-all duration-300"
                >
            ...
            <motion.div
              ...
              className="mt-8 p-6 bg-accent text-paper"
            >
              <h4 className="text-lg font-display mb-2">{t('readyToCollaborate')}</h4>
              <p className="text-paper mb-4 text-sm">
                {t('openToDiscuss')}
              </p>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleEmailClick}
                className="w-full bg-paper text-accent font-semibold py-3 px-6 hover:bg-paper-2 transition-colors duration-300"
              >
                {t('sendEmail')}
              </motion.button>
            </motion.div>
