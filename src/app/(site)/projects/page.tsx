...
export const metadata = {
  ...
  description: 'Portfolio of DevOps tools, extensions, and technology projects by Kaue Mendes',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16 pt-16">
          ...
          <p className="text-brand-neutral-light/80 text-lg mt-6 max-w-3xl mx-auto leading-relaxed">
            Explore my collection of DevOps tools, Azure extensions, and technology projects. 
            Each project represents a solution to real-world challenges in software development and operations.
          </p>
        </div>
        ...
        <div className="relative bg-gradient-to-r from-brand-accent1/20 to-brand-accent2/20 rounded-2xl p-8 md:p-12 text-center border border-brand-accent1/30 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-brand-neutral-light/80 mb-8 max-w-2xl mx-auto">
              I create custom DevOps tools, Azure extensions, and automation solutions for businesses. 
